  ...
  return (
    <div>
      ...
      <div className="w-full max-w-100 md:max-w-250 mx-auto py-10 px-4 md:text-lg text-base text-justify">
        ...
        <br/><p>This website was created using the following technologies; NextJS as the front-end, TailwindCSS for the styling, and ShadCN as component library. Other miscellaneous technologies such as Google Maps integration through embeds, GitHub for version control, and Vercel for static-site hosting. All images showcasing each destinations are available publicly in their respective Facebook Pages. The code for this website is open-sourced and is available for viewing, it can be found <a className="text-blue-700 underline decoration-none" href="https://github.com/Profility/walking-tours">here{<ExternalLink className="inline-flex mx-1" size={16}/>}</a></p>      
      </div>
    </div>
  );
}
